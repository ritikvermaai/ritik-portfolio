...
// Compatibility model for the original HTML homepage editor.
// The previous code referenced Homepage without defining it.
...
app.get(/^(?!\/api(?:\/|$)|\/admin\/api(?:\/|$)|\/admin\/status$|\/admin\/login$|\/admin\/logout$|\/admin\/projects(?:\/|$)|\/admin\/visitor(?:-|\/)|\/run(?:\/|$)|\/projects$|\/save$|\/download(?:\/|$)|\/delete(?:\/|$)|\/create-order$|\/verify-payment$|\/donation-stats$|\/visitor-count$)/, sendReactApp);
